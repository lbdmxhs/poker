 ...
 */
module.exports.create = function(uid, timestamp, pwd,iv) {
	var msg = uid + '|' + timestamp;
	var cipher = crypto.createCipheriv('aes-256-cbc', pwd,iv);
 ...
 */
module.exports.parse = function(token, pwd,iv) {
	var decipher = crypto.createDecipheriv('aes-256-cbc', pwd,iv);
	var dec;
	try {
